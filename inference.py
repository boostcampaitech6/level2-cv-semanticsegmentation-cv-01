...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_dir', type=str, default="/data/ephemeral/home/level2-cv-semanticsegmentation-cv-01/work_dirs/exp", help="load model at /opt/ml/input/code/{model_dir} (default : exp))")
    ...
    parser.add_argument('--image_root', type=str, default="/data/ephemeral/home/level2-cv-semanticsegmentation-cv-01/data/test/DCM", help="test image root (default: /opt/ml/input/data/test/DCM)")
